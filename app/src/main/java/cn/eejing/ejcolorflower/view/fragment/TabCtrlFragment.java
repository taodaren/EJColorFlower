...
import cn.eejing.ejcolorflower.view.adapter.TabCtrlAdapter;
...
public class TabCtrlFragment extends BaseFragment {
    ...
    private TabCtrlAdapter mAdapter;
...
//    }
    ...
    private void initRecyclerView() {
        ...
        // 绑定适配器
        mAdapter = new TabCtrlAdapter(getContext(), mList, mMemberId, mToken);
