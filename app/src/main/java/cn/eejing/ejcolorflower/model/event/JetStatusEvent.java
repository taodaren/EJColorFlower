...
public class JetStatusEvent {
    ...
    public JetStatusEvent(String mType, String mDirection, String mGap, String mDuration, String mGapBig, String mLoop, int mGroupId) {
        this.mType = mType;
    ...
    public JetStatusEvent(String mType, String mGap, String mDuration, String mFrequency, int mGroupId) {
        this.mType = mType;
        this.mGap = mGap;
        this.mDuration = mDuration;
