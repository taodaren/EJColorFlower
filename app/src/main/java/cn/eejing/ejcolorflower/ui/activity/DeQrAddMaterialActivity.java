...
public class DeQrAddMaterialActivity extends BaseActivity implements View.OnClickListener, QRCodeView.Delegate {
    ...
    protected int layoutViewId() {
        return R.layout.activity_de_qr_add_material;
    }
